...
*   **統一卡片風格**: 所有卡片組件使用統一的設計風格：
    *   `border-2 border-black` - 黑色邊框（2px）
    *   `bg-white` - 白色背景
    *   `rounded-lg` - 圓角
    *   `shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]` - 黑色陰影效果
    *   可交互卡片支援 hover 效果：`hover:bg-gray-50` 和 `hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]`
*   **修改指南**:
